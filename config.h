...
static Key keys[] = {
	...
	{ 0,                    XF86XK_AudioMute,           spawn,      SHCMD("vol.sh -c 0") },
	{ 0,                    XF86XK_AudioMute,           spawn,      SHCMD("vol.sh -c 0") },
	{ 0,                    XF86XK_AudioLowerVolume,    spawn,      SHCMD("vol.sh -c -5") },
	{ 0,                    XF86XK_AudioRaiseVolume,    spawn,      SHCMD("vol.sh -c +5") },
	{ ControlMask,          XF86XK_AudioLowerVolume,    spawn,      SHCMD("vol.sh -c -2") },
	{ ControlMask,          XF86XK_AudioRaiseVolume,    spawn,      SHCMD("vol.sh -c +2") },
	{ ShiftMask,            XF86XK_AudioLowerVolume,    spawn,      SHCMD("vol.sh -c -10") },
	{ ShiftMask,            XF86XK_AudioRaiseVolume,    spawn,      SHCMD("vol.sh -c +10") },
	{ MODKEY,               XF86XK_Back,                spawn,      SHCMD("vol.sh -c -1") },
	{ MODKEY,               XF86XK_Forward,             spawn,      SHCMD("vol.sh -c +1") },
