...
static const Rule rules[] = {
	...
	**/
	...
	{ "scratchpad",    NULL,         "scratchpad",    0,      1,      1,      1,      1,      -1,     's' },
	{ "scratchpad",    NULL,         "calculator",    0,      0,      1,      0,      1,      0,      'c' },
	...
	{ NULL,           "Navigator",  NULL,            0,      0,      0,      0,      -1,     -1,     0   },
	{ NULL,           "Browser",    NULL,            0,      1,      1,      0,      -1,     -1,     0   },
	{ NULL,           "Places",     NULL,            0,      1,      1,      0,      -1,     -1,     0   },
...
/* primary scratchpads */
static const char *scratchpadcmd[] = { "s", "st", "-t", "scratchpad", "-c", "scratchpad", "-g", "135x40", NULL };
...
static Key keys[] = {
	...
	{ MODKEY,               XK_Prior,                   spawn,      SHCMD("vol -c -1") },
	{ MODKEY,               XF86XK_Forward,             spawn,      SHCMD("vol -c +1") },
	{ MODKEY,               XK_Next,                    spawn,      SHCMD("vol -c +1") },
...
#if 0
	{ 0,                            XF86XK_MonBrightnessDown, spawn,   SHCMD("sys-brightness dec") },
	{ 0,                            XF86XK_MonBrightnessUp,   spawn,   SHCMD("sys-brightness inc") },
#endif
};
